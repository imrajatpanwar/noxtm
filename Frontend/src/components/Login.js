    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="login-logo">
          <span className="login-logo-text">noxtm</span>
        </div>

        {/* Heading */}
        <h1 className="login-title">Welcome back</h1>
        <p className="login-subtitle">Login with your Google account or email</p>
        ...
        {/* Google Login Button */}
        <button type="button" className="login-social-btn" onClick={handleGoogleLogin}>
        ...
        <p className="login-terms">
          ...
          <a href="/legal/terms" className="login-terms-link">Terms of Service</a>{' '}
          and{' '}
          <a href="/legal/privacy" className="login-terms-link">Privacy Policy</a>.
        </p>
      </div>
    </div>
  );
