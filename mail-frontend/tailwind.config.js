  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "dialog-overlay-in": "fade-in 0.25s ease-out",
        "dialog-content-in": "dialog-content-show 0.25s cubic-bezier(0.16, 1, 0.3, 1)",
        "dialog-overlay-out": "fade-out 0.2s ease-in",
        "dialog-content-out": "dialog-content-hide 0.2s ease-in",
      },
    },
  },
  plugins: [],
